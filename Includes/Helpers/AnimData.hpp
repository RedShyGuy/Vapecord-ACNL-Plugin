...
namespace CTRPluginFramework {
	...
	class AnimData {
		public:
			...
			void		DoorOpen_44();
			void		Null_D9_75();
			void		Pick_3C_3D(u8 dropID, u32 itemID, Coord worldCoords);

			void		FaceCutoutStandee_C1(u8 option);
			void    	Appearance_B9(u16 animItem, u8 appearance[] = nullptr);
			void		OpenMailBox_8B_DE();
			void		CloseMailBox_8C_DF();
			void		BuryItem_53_52(Coord worldCoords);
			void		Bury_4F(Coord worldCoords);
			void		BuryOut_50_51(u32 animItem, Coord worldCoords);
			...
			void		HoldTool_3C(u32 animItem, u8 emotion, Coord worldCoords);
			void		ShovelHitsNothing_4A(u8 emotion, Coord worldCoords);
			void		ChangeOutfit_36(u32 animItem, u8 emotion);
			...
			void		FishFall_B3_B4_B5(u32 animItem, Coord worldCoords);
			void		Null_95_33(Coord worldCoords);
			void		PickUp_3E(u32 animItem, u16 snake);
			void		EquipItem_38(u32 animItem);
			void		PickPluck_41_42(u32 animItem);
			void		Null_B7_71_72_24_3F_3D_92_93_94(u32 animItem);
			void		Null_Default(u32 animItem, Coord worldCoords);
