...
namespace CTRPluginFramework {
    ...
    */
    constexpr ID_U8Data Music[] = {
        ...
        { "Main Street 2 (Night) Intro", 0x70 }, //Probably
        { "Main Street 3 (Night) Intro", 0x71 }, //Probably
        { "Main Street 1 (Night - Rain) Intro", 0x72 },
        { "Main Street 2 (Night - Rain) Intro", 0x73 }, //Probably
        { "Main Street 3 (Night - Rain) Intro", 0x74 }, //Probably
        { "Main Street 1 (Night)", 0x75 },
        { "Main Street 2 (Night)", 0x76 }, //Probably
        { "Main Street 3 (Night)", 0x77 }, //Probably
        { "Main Street 1 (Night - Rain)", 0x78 },
        { "Main Street 2 (Night - Rain)", 0x79 }, //Probably
        { "Main Street 3 (Night - Rain)", 0x7A }, //Probably
        ...
        { "PLACEHOLDER", 0xE7 }, //Crashes maybe!
        { "Campground (Night)", 0xE8 },
        { "Campground (Night - Rain)", 0xE9 },
        { "Campground (Night - Snow)", 0xEA },

        //idk if there are more, test at the end

        //{ "Train (Prologue)", 0x268 } //Very weird, surely there is something wrong with it
    };
