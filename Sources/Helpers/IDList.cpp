...
//get country name
	...
	/*
	DAT greift direkt auf Methode von code.bin zu
	FUN ist wrapper für Methoden in code.bin

	DAT_00001C10 = 0x5E40E8;
	FUN_00001C14 = 0x5E3F94;
	FUN_00001324 = 0x7712C0;

	_LAB_00003d54 = 0xC086E0;
	_LAB_00003d58 = 0xC0CE88;
	_LAB_00003D5C = 0xAAFF18;
	_LAB_00003d70 = 0xC086B8; //Könnte andere CRO sein :/

	DAT_00001c18 = 0x5E3F94;
	FUN_00001c1c = 0x6044BC;
	FUN_000012c4 = 0x6F02F4;

	_LAB_00003d60 = 0xC086D0;
	_LAB_00003d6c = 0x849D0C;

	FUN_0000132C = 0x771278;
	FUN_00001144 = 0x2FCC14;
	FUN_00001334 = 0x76A66C;
	FUN_0000114c = 0x2FEA78;
	FUN_0000130c = 0x75C5B8;
	*/
	...
	bool SearchItemByKeywordFUNC(u32 param_1/*0x307A6B70*/) {
		static Address FUN_00001324(0x7712C0); //Returns u32
		static Address FUN_000012c4(0x6F02F4); //Returns bool
		static Address FUN_00001144(0x2FCC14); //Returns shortened item (?), or u16
		static Address FUN_00001334(0x76A66C); //Returns u32
		static Address FUN_00001154(0x2F776C); //Returns void, probably thunk
		static Address FUN_0000114c(0x2FEA78); //Returns u32(?)
		static Address FUN_0000130c(0x75C5B8); //Returns u32(?)
		static Address FUN_0000115c(0x5F56E4); //Returns u32, probably thunk
		static Address FUN_00001164(0x308368); //Returns void, probably thunk
		static Address FUN_0000101c(0x30B6BC); //Returns u16, checks item & 0x7FFF
		static Address FUN_0000133c(0x2FD0BC); //Returns u32 (?)
		static Address FUN_00001344(0x301B3D); //Returns u32

		u32 _LAB_00003d54 = *(u32 *)(0xC086E0);
		...
		int* StepCounter = (int *)(param_1 + 0x1C14); //maybe not step counter, not sure, increments each do while increment
		...
		//Set to next category, unsure yet why it is a while loop
			while (uVar3 = FUN_00001324.Call<u32>(param_1 + 0x58), uVar3 <= *StepCounter) {
				(*ItemCategoryIndex)++;
			...
			//If all categories got searched -> exit
				...
				FUN_000012c4.Call<bool>(param_1 + 0x58, saveOffset + 0x6C20, (u8)Categories_To_Search[*ItemCategoryIndex]);
			...
			uVar4 = GetItemByCategory(param_1 + 0x58, Categories_To_Search[*ItemCategoryIndex], *StepCounter);
			FUN_00001144.Call<u16>(Stack1_34, uVar4); //goes through every item by category
			
			iVar5 = FUN_00001334.Call<u32>(Stack1_34);
			if (iVar5 != 0) {
				FUN_0000114c.Call<u32>(local_b8, Stack1_34, 0);

				iVar5 = FUN_0000130c.Call<u32>(local_b8, param_1 + 0x38, 1);
				if (iVar5 == 0) {
				...
				LAB_00003b7c:
						...
						do {
							if ((*(u32 *)(param_1 + 0x1C20) & uVar3) != 0) {
								piVar7 = (u32 *)(_LAB_00003d54 + uVar9 * 8);
								bVar13 = (piVar7[1] & 1U) == 0;

								if (bVar13) {
									pcVar8 = new Address(*piVar7);
								}

								piVar6 = (u32 *)(param_1 + (piVar7[1] >> 1));
								if (!bVar13) {
									pcVar8 = new Address(*piVar6 + *piVar7);
								}
				...
				LAB_00003b84:
					uVar2 = FUN_0000101c.Call<u16>(Stack1_34);

					if (*(u32 *)(param_1 + 0x44) == 0) {
						*(u32 *)(param_1 + 0x54) = *(u32 *)(param_1 + 0x54) + 1;

						uVar4 = FUN_0000133c.Call<u32>(0xBC4, _LAB_00003d64);
						iVar5 = FUN_00001344.Call<u32>(uVar4, (u32)FUN_BE57C4, 0x5C, 0x20);
				...
				iVar5 = FUN_0000115c.Call<u32>(Stack2_AC);
				FUN_00001164.Call<void>(iVar5 + -0xC);
			}
			...
			if (MAX_VALUE <= iVar11) {
				FUN_00001154.Call<void>(Stack1_34);
				return 0;
			}
			FUN_00001154.Call<void>(Stack1_34);
		} while(true);
